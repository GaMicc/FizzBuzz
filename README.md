...
## Task 0 Forking a public repository on GitHub THIS IS AN EDIT FOR TASK 3.4
...
- you can create a boolean simply on one line by writing boolean 
- you define with one = sign, while you compare with 2 =
- Java and is &&
- looking at the for loop, it starts at 1, goes until 100, and adds one (++) at each round
- you print with System.out.println("words)
...
- [X] Once you execute these it push`commands, you can check your GitHub repository to confirm that the changes have been made there.
